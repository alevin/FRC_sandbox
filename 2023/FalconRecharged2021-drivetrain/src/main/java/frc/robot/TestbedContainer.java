...
public class TestbedContainer {
  ...
  private void configureButtonBindings() {
    ...
    JoystickButton leftBumper =
        new JoystickButton(mXboxController, XboxController.Button.kLeftBumper.value);
    JoystickButton rightBumper =
        new JoystickButton(mXboxController, XboxController.Button.kRightBumper.value);
    ...
    // JoystickButton buttonA_2 = new JoystickButton(mXboxController2,
