...
public class SwerveDriveModule extends SubsystemBase {
  ...
  public SwerveDriveModule(
    ...
    driveMotor.configSelectedFeedbackSensor(
        FeedbackDevice.IntegratedSensor, 0, 0); // ADD TO CANSPARKMAX LATER***
  ...
  /*
   * Daphne one values
   * public SwerveDriveModule(int moduleNumber, TalonSRX angleMotor, TalonFX
   * driveMotor, double zeroOffset) {
   * mModuleNumber = moduleNumber;
   *
   * mAngleMotor = angleMotor;
   * mDriveMotor = driveMotor;
