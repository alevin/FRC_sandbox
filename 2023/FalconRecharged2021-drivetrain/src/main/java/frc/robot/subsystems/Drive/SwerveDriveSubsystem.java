...
public class SwerveDriveSubsystem
  ...
  public SwerveDriveSubsystem(
      ...
      SwerveDriveModule m3) { // add PID controll stuff for Drive Motors
  ...
  public void driveForwardDistance(double targetPos, double angle) { // inches & degrees
    ...
    for (int i = 0; i < 4; i++) {
      ...
      mSwerveModules[i].setTargetDistance(
          targetPos + mSwerveModules[i].getDriveMotor().getSelectedSensorPosition());
    }
  ...
  public void periodic() { // is this needed here?
    SmartDashboard.putBoolean(
        "Mod 0 Motor Inversion", mSwerveModules[0].getDriveMotor().getInverted());
    SmartDashboard.putBoolean(
        "Mod 1 Motor Inversion", mSwerveModules[1].getDriveMotor().getInverted());
    SmartDashboard.putBoolean(
        "Mod 2 Motor Inversion", mSwerveModules[2].getDriveMotor().getInverted());
    SmartDashboard.putBoolean(
        "Mod 3 Motor Inversion", mSwerveModules[3].getDriveMotor().getInverted());
