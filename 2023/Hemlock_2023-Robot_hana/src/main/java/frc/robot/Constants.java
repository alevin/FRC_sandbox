...
public final class Constants {
  ...
  public static final int BACK_RIGHT_MODULE_STEER_ENCODER = 13;
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -toRadians( 141.0 );
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -toRadians( 35.0); // 39
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -toRadians( 158.0 ); //147
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -toRadians( 253.0 ); //240

    public static final int PIGEON_ID = 000 ;
    ...
    public static final double MAX_VELOCITY_METERS_PER_SECOND = SPEED_MULTIPLIER * 6380.0 / 60.0 *
        ModuleConfiguration.MK4_L3.getDriveReduction() *
        ModuleConfiguration.MK4_L3.getWheelDiameter() * PI;
